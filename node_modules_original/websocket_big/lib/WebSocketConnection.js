...
function WebSocketConnection(socket, extensions, protocol, maskOutgoingPackets, config) {
    ...
    this.socket.on('drain', this.drain.bind(this));
...
WebSocketConnection.prototype.data = function(data) {
...
WebSocketConnection.prototype.error = function(error) {
...
WebSocketConnection.prototype.close = function(hadError) {
